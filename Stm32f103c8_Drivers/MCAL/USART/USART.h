...
typedef struct
{
	uint16	USART_Mode;			// Specifies TX/RX Enable/Disable
	...
	uint16	Payload_Length;		// Specifies the number of data bits transmitted or received in a frame
	...
	uint16	IRQ_Enable;			// enable or disable the interrupt

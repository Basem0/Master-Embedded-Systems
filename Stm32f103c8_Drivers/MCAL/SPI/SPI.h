...
void MCAL_SPI_Send_Data(SPI_Typedef_t *SPIx, uint16 *pTxBuffer, enum Polling_Mechanism Polling_En);
void MCAL_SPI_Recieve_Data(SPI_Typedef_t *SPIx, uint16 *pRxBuffer, enum Polling_Mechanism Polling_En);

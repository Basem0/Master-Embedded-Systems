...
#define GPIO_PIN_16						((uint16)0xFFFF) /* All pins selected */
...
uint8 MCAL_GPIO_ReadPin(GPIO_Typedef_t *GPIOx, uint16 PinNumber);
uint16 MCAL_GPIO_ReadPort(GPIO_Typedef_t *GPIOx);
...
void MCAL_GPIO_TogglePin(GPIO_Typedef_t *GPIOx, uint16 PinNumber);

uint8 MCAL_GPIO_LockPin(GPIO_Typedef_t *GPIOx, uint16 PinNumber);

...
/************************************************************************/
typedef volatile unsigned char              vuint8_t;    /* 8-bit volatile unsigned integer */
typedef volatile unsigned short             vuint16_t;   /* 16-bit volatile unsigned integer */
typedef volatile unsigned int               vuint32_t;   /* 32-bit volatile unsigned integer */
typedef volatile unsigned long long int     vuint64_t;   /* 64-bit volatile unsigned integer */

/************************************************************************/
/*               Volatile Signed Integer Types                          */
/************************************************************************/
typedef volatile signed char                vsint8_t;    /* 8-bit volatile signed integer */
typedef volatile signed short               vsint16_t;   /* 16-bit volatile signed integer */
typedef volatile signed int                 vsint32_t;   /* 32-bit volatile signed integer */
typedef volatile signed long long int       vsint64_t;   /* 64-bit volatile signed integer */

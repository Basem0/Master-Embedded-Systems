...
const uint8 APBPrescTable[8U] = {0,0,0,0,1,2,3,4}; // Shift 1 right == multiply by 2
...
const uint8 AHBPrescTable[16U] = {0,0,0,0,0,0,0,0,1,2,3,4,6,7,8,9}; // Shift 1 right == multiply by 2
